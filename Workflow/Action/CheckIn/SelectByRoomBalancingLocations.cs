...
namespace cc.newspring.AttendedCheckIn.Workflow.Action.CheckIn
{
    ...
    /// </summary>
    [Description( "Selects the grouptype, group, location and schedule for each person based on the location with the least number of people." )]
    [Export( typeof( ActionComponent ) )]
    [ExportMetadata( "ComponentName", "Select By Room Balancing" )]
    public class SelectByRoomBalancingLocations : CheckInActionComponent
    {
        /// <summary>
