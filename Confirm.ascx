            ...
            <div class="row">
                ...
                <ContentTemplate>
                    <div class="grid in-the-middle">
                        <Rock:Grid ID="gPersonList" runat="server" DataKeyNames="PersonId,LocationId,ScheduleId" DisplayType="Light" OnRowCommand="gPersonList_Print"  CssClass="three-col-with-controls" ShowFooter="false" EmptyDataText="No People Selected" OnGridRebind="gPersonList_GridRebind">
                            <Columns>
