            ...
            rockContext.WrapTransaction( () =>
            {
                ...
                foreach ( GroupType groupTypeUI in groupTypesToAddUpdate )
                {
                    ...
                    if ( groupTypeDB == null )
                    {
                        ...
                        var defaultMemberRole = new GroupTypeRole();
                        defaultMemberRole.Name = "Member";
                        defaultMemberRole.IsSystem = false;
                        defaultMemberRole.Order = 0;
                        groupTypeDB.Roles.Add( defaultMemberRole );
                    }
                    ...
                    // set the Default Group Role if it doesn't exist
                    if ( groupTypeDB.DefaultGroupRole == null && groupTypeDB.Roles.Any() )
                    {
                        groupTypeDB.DefaultGroupRole = groupTypeDB.Roles.FirstOrDefault();
                    }
